...
DEFAULT_TASKS = [
    ...
    ('pre_joining', 'Department confirmed', 'hr'),
    ('pre_joining', 'Designation Offered confirmed', 'hr'),
    ('pre_joining', 'Location confirmed', 'hr'),
    ('pre_joining', 'Replacement/New classification', 'hr'),
    ('pre_joining', 'Sub-Department confirmed', 'hr'),
    ('pre_joining', 'Employee Type confirmed', 'hr'),
    ('pre_joining', 'Date of Birth collected', 'hr'),
    ('pre_joining', 'Personal Mail ID collected', 'hr'),
    ('pre_joining', 'Contact Numbers collected', 'hr'),
    ('pre_joining', 'Office Location confirmed', 'hr'),
    ('pre_joining', 'Reporting Manager confirmed', 'hr'),
    ('pre_joining', 'Date of Offer confirmed', 'hr'),
    ('pre_joining', 'Date of offer acceptance', 'hr'),
    ('pre_joining', 'Recruiter assigned', 'hr'),
